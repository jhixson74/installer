...
replace (
	...
	github.com/hashicorp/terraform-plugin-sdk => github.com/jhixson74/hashicorp-terraform-plugin-sdk v1.14.0-jhixson-openshift // Pin to fork with public rpc types
	...
	github.com/terraform-providers/terraform-provider-aws => github.com/jhixson74/terraform-provider-aws v1.60.1-0.20200630224953-76d1fb4e5699 // Pin to openshift fork with tag v2.60.0-openshift-1
