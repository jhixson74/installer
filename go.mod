...
replace (
	...
	github.com/terraform-providers/terraform-provider-aws => github.com/jhixson74/terraform-provider-aws v1.60.1-0.20200519001524-19eb957857c6 // Use OpenShift fork
